...
def update_purchase_receipt_rates(doc, method):
    ...
    # Logic moved to erpnextkta.overrides.KTAPurchaseReceipt.KTAPurchaseReceipt.update_rates_logic
    # This hook is disabled to prevent conflicts and redundant calculations.
    return

    # 1. Update Exchange Rate (LEGACY / DISABLED)
